-- ============================================================
-- Unggul Axiom Hub — Migration 001
-- Phase 7: Core Schema — users, files, audit_logs
-- Applied via: backend/migrations/001_core_schema.sql
-- ============================================================
...
-- ── Users ───────────────────────────────────────────────────
-- Stores authenticated principals. Roles: 'admin' | 'staff'.
...
-- `classification` aligns with Malaysian Government classification tiers.
...
-- ── Audit Logs ───────────────────────────────────────────────
-- Immutable append-only log. No UPDATE / DELETE allowed by convention.
...
VALUES ('0001', 'Phase 7: Core schema — users, files, audit_logs')
