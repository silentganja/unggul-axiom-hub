          ...
          <div className="pt-4 border-t border-border/10 mt-4">
            <div className="p-3 rounded border border-border/20 bg-background-panel/20 space-y-2 text-[10px] font-mono text-foreground-subtle">
              ...
              <p className="leading-relaxed">
                All platform processes, file reads, and classification modifications are registered in secure audit records. Act responsibly in accordance with corporate policies.
              </p>
            </div>
          </div>
        </aside>
            ...
            <aside className="relative w-64 border-r border-border/20 bg-background-panel/95 p-4 space-y-4 flex flex-col justify-between animate-in slide-in-from-left duration-200">
              ...
              <div className="p-3 rounded border border-border/20 bg-background/30 text-[10px] font-mono text-foreground-subtle">
                ...
                <p className="leading-relaxed mt-1">
                  All updates, uploads, and share requests generate immutable database logs. Refer to section 4 for administrative guidelines.
                </p>
              </div>
            </aside>
          </div>
        ...
        <main className="flex-1 overflow-y-auto px-4 py-6 sm:p-8 flex flex-col justify-between min-w-0">
          ...
          <footer className="w-full max-w-4xl border-t border-border/10 pt-6 mt-12 flex flex-col sm:flex-row items-center justify-between gap-2 font-mono text-[8px] uppercase tracking-[0.18em] text-foreground-subtle select-none">
            <div className="flex items-center gap-2">
              ...
              <span>SYSTEMS OPERATIONS MANUAL</span>
            </div>
            <div className="flex items-center gap-4">
              <span>MANUAL VERSION 2.0.0</span>
              <span className="hidden sm:inline text-foreground-subtle/30">|</span>
              <span className="hidden sm:inline">AUTHENTICATED CONTEXT</span>
            </div>
            <span className="flex items-center gap-1">
              <Lock size={9} className="text-accent" /> SECURE DOCUMENTATION
            </span>
          </footer>
        </main>
      </div>
